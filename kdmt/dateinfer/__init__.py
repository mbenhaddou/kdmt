...
import kdmt.localized_dateutil
#from kdmt.dateinfer.infer import infer
from kdmt import dateparser

import copy
import logging
import regex as re
from kdmt.dateinfer.date_fragment import DateFragment
from kdmt.dateinfer.constants import (
    REPLACEMENTS,
    DELIMITERS_PATTERN,
...
class DateFinder(object):
    ...
    #     date_string=self.sanitize_text(date_string)
    #     try:
    #         as_dt = parser.parse(
    #             date_string,
    ...
    #             parserinfo=kdmt.localized_dateutil.LocaleParserInfo()
    #         )
    ...
    #         date_string = self.sanitize_text(date_string.strip(STRIP_CHARS))
    #
...
if __name__=="__main__":
    di =DateFinder()
    '5 aug. 2020 om 14:26 heeft "energie@octaplus.be" <energie@octaplus.be> het volgende '
#    date_strs=di.extract_date_strings('Wed, 13 Mar 2019 at 17:52, <energie@octaplus.be<mailto:energie@octaplus.be>>')

    matches =find_dates('Wednesday, June 10, 2020 2:29:49 PM')
