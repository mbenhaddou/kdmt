...
def get_entities(seq, suffix=False):
    ...
    Example:
        >>> from kdmt.ml.metrics.sequence_labeling import get_entities
...
def sequence_f1_score(y_true, y_pred, suffix=False):
    ...
    Example:
        >>> from kdmt.ml.metrics.scores import sequence_f1_score
...
def sequence_accuracy_score(y_true, y_pred):
    ...
    Example:
        >>> from kdmt.ml.metrics.scores import sequence_accuracy_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'],
        >>> ['B-PER', 'I-PER', 'O']]
...
def sequence_precision_score(y_true, y_pred, suffix=False):
    ...
    Example:
        >>> from kdmt.ml.metrics.scores import sequence_precision_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'],
        >>> ['B-PER', 'I-PER', 'O']]
...
def sequence_recall_score(y_true, y_pred, suffix=False):
    ...
    Example:
        >>> from kdmt.ml.metrics.scores import sequence_recall_score
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'],
        >>> ['B-PER', 'I-PER', 'O']]
...
def sequence_performance_measure(y_true, y_pred):
    ...
    Example:
        >>> from kdmt.ml.metrics.scores import sequence_performance_measure
...
def classification_report(y_true, y_pred, digits=2, suffix=False):
    ...
    Examples:
        >>> from kdmt.ml.metrics.scores import classification_report
        >>> y_true = [['O', 'O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'O'], ['B-PER', 'I-PER', 'O']]
        >>> y_pred = [['O', 'O', 'B-MISC', 'I-MISC', 'I-MISC', 'I-MISC', 'O'],
        >>> ['B-PER', 'I-PER', 'O']]
