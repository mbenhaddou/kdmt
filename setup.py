...
setup(
    ...
    install_requires=["pandas", "scikit-learn", "simplejson", "numpy", "requests", "decorator", "urlparser", "tqdm", "progressbar", "regex", "matplotlib", "importlib-resources","importlib-metadata", "azure-storage-blob", "importlib-metadata"],
    classifiers=[
